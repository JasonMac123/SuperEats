  ...
  return (
    <View style={tw`flex-1`}>
      <FlatList
        ...
        ListHeaderComponent={() => (
          <>
            <View style={tw`gap-4 `}>
              ...
              <View
                style={tw`flex-row bg-white py-4 px-4 border border-gray-400`}
              >
                <MaterialIcons name="delivery-dining" size={32} color="black" />
                <Text style={tw`flex-1 mx-2`}>
                  Deliver from {getDeliveryTime(deliveryTime).join(" - ")}{" "}
                  minutes{" "}
                </Text>
        ...
        ListFooterComponent={
          <View style={tw`bg-white mx-4 mb-32 mt-2 gap-4 py-2`}>
            ...
            <View style={tw`flex-row justify-between mx-2`}>
              <Text style={tw`text-xl text-neutral-400`}>Total</Text>
